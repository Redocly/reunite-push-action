...
// The types below mirror the Reunite API responses. They used to be imported
// from `@redocly/cli/lib/reunite/api/types`, but the published CLI package no
// longer exposes its internal modules (it ships as a self-contained bundle
// since v2.34.0), so the action keeps its own copy.
